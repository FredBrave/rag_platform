# Generated by Django 5.1.2 on 2025-08-12 22:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conversacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mensajes', to='infrastructure.conversacion')),
            ],
        ),
        migrations.CreateModel(
            name='RAG',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documentos', to='infrastructure.rag')),
            ],
        ),
        migrations.AddField(
            model_name='conversacion',
            name='rag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversaciones', to='infrastructure.rag'),
        ),
        migrations.CreateModel(
            name='Embedding',
            fields=[
                ...
                ('documento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='embeddings', to='infrastructure.documento')),
            ],
            options={
                'ordering': ['indice'],
                'indexes': [models.Index(fields=['indice'], name='infrastruct_indice_3206e7_idx'), models.Index(fields=['documento'], name='infrastruct_documen_4d8729_idx')],
            },
        ),
        migrations.CreateModel(
            name='RAGPermiso',
            fields=[
                ...
                ('rag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permisos', to='infrastructure.rag')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
